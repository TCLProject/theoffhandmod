...
public final class ItemStackTransformer extends TransformerMethodProcess {
    ...
    void processMethod(MethodNode method) {
        ...
        while (it.hasNext()) {
            ...
            if (node instanceof MethodInsnNode && node.getOpcode() == INVOKEVIRTUAL) {
                ...
                if (methNode.owner.equals(entityPlayerClassName) && (methNode.name.equals(destroyMethodName.split("!")[0]) || methNode.name.equals(destroyMethodName.split("!")[1])) && methNode.desc.equals(SIMPLEST_METHOD_DESC)) {
    ...
    void setupMappings() {
        ...
        destroyMethodName = "func_71028_bD!destroyCurrentEquippedItem";
    }
}
