...
public final class ItemRendererTransformer extends TransformerBase {
    ...
    boolean processMethods(List<MethodNode> methods) {
        ...
        for (MethodNode mn : methods) {
            if ((mn.name.equals(renderItem1stPersonMethodName.split("!")[0]) || mn.name.equals(renderItem1stPersonMethodName.split("!")[1])) && mn.desc.equals(renderItem1stPersonMethodDesc)) {
            	processRenderItemMethod(mn);
                found++;
            } else if ((mn.name.equals(updateEquippedItemMethodName.split("!")[0]) || mn.name.equals(updateEquippedItemMethodName.split("!")[1])) && mn.desc.equals(SIMPLEST_METHOD_DESC)) {
    ...
    void setupMappings() {
        ...
        itemRendererMinecraftField = CustomLoadingPlugin.isObfuscated() ? "field_78455_a" : "mc";

        renderItem1stPersonMethodName = "func_78440_a!renderItemInFirstPerson";
        renderItem1stPersonMethodDesc = "(F)V";

        updateEquippedItemMethodName = "func_78441_a!updateEquippedItem";
    }
}
