...
public final class NetServerHandlerTransformer extends TransformerBase {
    ...
    boolean processMethods(List<MethodNode> methods) {
        ...
        for (MethodNode mn : methods) {
            if ((mn.name.equals(handleBlockSwitchMethodName.split("!")[0]) || mn.name.equals(handleBlockSwitchMethodName.split("!")[1])) &&
                    mn.desc.equals(handleBlockSwitchMethodDesc)) {
                if (processSwitchBlockMethod(mn))
                    found++;
            } else if ((mn.name.equals(handlePlaceMethodName.split("!")[0]) || mn.name.equals(handlePlaceMethodName.split("!")[1])) &&
    ...
    void setupMappings() {
        ...
        getItemSwitchId = "func_149614_c";
        handleBlockSwitchMethodName = "func_147355_a!processHeldItemChange";
        handleBlockSwitchMethodDesc = "(L" + packet16BlockItemSwitchClassName + ";)V";

        handlePlaceMethodName = "func_147346_a!processPlayerBlockPlacement";
